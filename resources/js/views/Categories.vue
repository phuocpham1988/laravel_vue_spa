	      ...
	      <div class="col">
	        <div class="card mb-4">
	          <div class="card-header d-flex">
	            ...
	            <button class="btn btn-sm ml-auto" v-on:click="showNewCategoryModal"><span class="fa fa-plus"></span> Create New</button>
	          </div>
	          <div class="card-body">
	          	<table class="table">
	          		<thead>
	          		...
	          		<tbody>
	          			<tr v-for="(category, index) in categories" :key="index">
	          				...
	          				<td>{{category.name}}</td>
	          				<td>
	          					<img class="table-image" :src="`${$store.state.serverPath}/storage/${category.image}`" :alt="category.name" />
	          				</td>
	          				<td>
