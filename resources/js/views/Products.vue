	      ...
	      <div class="col">
	        <div class="card mb-4">
	          <div class="card-header d-flex">
	            ...
	            <button class="btn btn-sm ml-auto" v-on:click="showNewProductModal"><span class="fa fa-plus"></span> Create New</button>
	          </div>
	          <div class="card-body">
	          	<table class="table">
	          		<thead>
	          		...
	          		<tbody>
	          			<tr v-for="(product, index) in products" :key="index">
	          				<td>{{index+1}}</td>
	          				<td>{{findCatgeory(product.category_id)}}</td>
	          				<td>{{product.name}}</td>
	          				<td>
