...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _services_product_service__WEBPACK_IMPORTED_MODULE_1__["loadCategories"]();
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                if (window.confirm("Are you sure want to delete ".concat(product.name))) {
                  _context4.next = 2;
                  break;
                }
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 8:
                ...
                this.flashMessage.error({
                  message: 'Some error occured during more products',
                  time: 5000
                });
    ...
    findCatgeory: function findCatgeory(category_id) {
      var category_name = '';
...
var render = function() {
  ...
  return _c("main", [
    _c(
      ...
      [
        _c("h1", { staticClass: "mt-4" }, [_vm._v("Products")]),
        _vm._v(" "),
                  ...
                  _c(
                    ...
                    _vm._l(_vm.products, function(product, index) {
                      return _c("tr", { key: index }, [
                        ...
                        _vm._v(" "),
                        _c("td", [
                          _vm._v(_vm._s(_vm.findCatgeory(product.category_id)))
                        ]),
                        _vm._v(" "),
